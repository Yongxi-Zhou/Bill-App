...
export default function Register(props){
    ...
    return(
        <div className = "formStyle">
            <form>
                <ul>
                    <li type = "none" className = "liCss"><label>账号：<input type = "text" placeholder = "请输入账号" className = "inputCss" name = "account" value = {account} onChange = {handleChange}></input></label>
                    ...
                    <hr className = "line"/></li>
                    <li type = "none" style = {{marginTop:"30px",marginLeft:"10px"}}><input type = "button" className="loginBtn" value = "注册" onClick = {registerAccount}></input></li>
                </ul>
            </form>
